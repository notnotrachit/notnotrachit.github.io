...
export default function ProjectCard(props) {
  ...
  return (
    ...
    <div data-aos="fade-up">
        <div className="card w-96 bg-neutral shadow-xl border border-primary hover:scale-110 transition-all ease-in-out duration-300">
          <figure>
            <Image
              src={props.image_url}
              alt="random"
            ...
            <div className="relative border border-primary bg-neutral p-1 lg:p-5 rounded-xl w-full lg:w-1/2">
              ...
              <label className="swap text-6xl" id={props.name+"swap"}>
                ...
                <div className="flex flex-wrap justify-center group swap-on">
                  ...
                  <a className="justify-self-end my-1 btn btn-primary bg-neutral/30 backdrop-blur-xl text-primary hover:text-neutral" href={props.live_url} target="_blank">Preview</a>
                  </div>
                </div>
              </label>
              ) :
              ...
              {props.techs &&
                ...
                <div className="btn-group btn-group-horizontal my-2">
                    ...
                    { props.live_url && (
                    <a className="btn btn-sm btn-outline" href={props.live_url} target="_blank">Preview</a>
                    )}
                    </div>
                </div>
            </div>
