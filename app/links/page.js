...
export default async function links() {
  ...
  return (
    <>
      ...
      <div className="flex justify-center py-10 overflow-x-hidden overflow-y-visible">
      ...
      <div className="flex justify-center text-left overflow-x-hidden overflow-y-hidden">
        <div className="text-4xl">Other Links</div>
      </div>
        ...
        {all_links.map((link) => (
          ...
          >
            <a href={link.link} target="_blank">
              <button className="btn btn-outline btn-primary normal-case backdrop-blur-md">
                {link.title}
              </button>
            </a>
          </div>
