...
export function SectionHeader({
	...
	return (
		...
		>
			...
			>
				<div className="flex items-center gap-2 text-primary font-mono text-sm tracking-widest bg-primary/10 px-4 py-1.5 border border-primary/20">
					<span className="text-primary font-bold">{number}</span>
					<span className="text-primary/80">{label}</span>
				</div>
				{!isCenter && (
					<div className="h-px flex-grow bg-gradient-to-r from-primary/30 to-transparent max-w-[200px]" />
				)}
			</div>
