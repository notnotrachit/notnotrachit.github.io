...
export function MagneticButton({
	...
	const content = (
        ...
        shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:shadow-[0_0_30px_rgba(6,182,212,0.4)]
        ${className}
      `}
		>
			<div className="absolute inset-0 bg-cyan-400 translate-y-[100%] transition-transform duration-300 ease-out-expo group-hover:translate-y-0" />
	...
	const props = href
		? { href, target, rel, className: "inline-block cursor-none group" }
