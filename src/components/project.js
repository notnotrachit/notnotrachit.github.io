      ...
      <figure>
        {props.image_name ? (
          <img
            ...
            width={300}
            height={200}
            className="mt-8 rounded-xl border border-primary/50 object-cover"
          />
        ) : (
          <img
            src={props.image_url}
                ...
                <div className="grid grid-cols-1 grid-rows-1">
                  {props.image_name ? (
                    <img
                      ...
                      width={500}
                      height={800}
                      className="place-self-center lg:w-96 p-2 group-hover:blur-sm transition-all ease-in-out rounded-xl row-start-1 row-end-1 col-start-1 col-end-1 z-[5] group-hover:z-[2] object-cover"
                    />
                  ) : (
                    <img
                      src={props.image_url}
            ...
            <div className="flex justify-center">
              {props.image_name ? (
                <img
                  ...
                  width={1000}
                  height={800}
                  className="place-self-center lg:w-[30rem] lg:max-w-96 p-2 group-hover:blur-sm transition-all ease-in-out rounded-xl row-start-1 row-end-1 col-start-1 col-end-1 z-[5] group-hover:z-[2] object-cover"
                />
              ) : (
                <img
                  src={props.image_url}
                  ...
                  width={1000}
                  height={800}
                  className="place-self-center lg:w-[30rem] p-2 group-hover:blur-sm transition-all ease-in-out rounded-xl row-start-1 row-end-1 col-start-1 col-end-1 z-[5] group-hover:z-[2] object-cover"
                />
              )}
            </div>
          )}
